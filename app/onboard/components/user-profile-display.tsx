      ...
      <div className="flex flex-col items-center justify-center pt-4 mx-3">
        <div className="text-center flex flex-col items-center justify-center">
          <img
            ...
            alt="Bordered avatar"
          />
          <p className="font-medium text-gray-700 py-2">@{`${formData.username}` || `identiFiDID`}</p>
          <p className="text-sm text-gray-700 py-1">{formData.info || "We making digital Identity easier..."}</p>
        </div>
        ...
        <div className="flex flex-col w-full ">
          ...
          <div className="flex flex-row items-center bg-gray-100 mt-2 space-x-2 px-3 py-2 rounded-lg">
            ...
            <p className="text-sm">{formData.phone_number || "+00 123 456 789"}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2 w-full">
          {formData.skills.map((skill: string, index: number) => (
            <div key={index} className="flex flex-row items-center bg-gray-100 w-max space-x-2 px-3 py-2 rounded-lg">
