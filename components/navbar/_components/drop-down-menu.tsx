  ...
  return (
    <div className="w-screen h-screen bg-white  px-2 items-center justify-center absolute  right-0 xl:hidden">
      <Accordion defaultValue="item-1" className="pl-2" type="single" collapsible>
        <Link href={"/"} className="flex flex-1 items-center  justify-between mt-11 pt-2 py-4 border-b">
          Home
        </Link>

        <Link href={"/jobs"} className="flex flex-1 items-center justify-between border-b py-4">
          Jobs
        </Link>

        <Link href={"/verify-identity"} className="flex flex-1 items-center justify-between py-4 border-b">
          Verify Identity
        </Link>
      </Accordion>
